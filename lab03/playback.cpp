  ...
  for(int iImage =0; iImage < nImages; iImage++)
  {
   ...
   for(int iH =0; iH < 64; iH++)
   {
         for(int iS =0; iS < 16; iS++)
         {
           ...
           //     if(aProbFloorHS[iH][iS][iV]>0 || aProbNonFloorHS[iH][iS][iV]>0)
           //     {
           //           cout<<"=================Before aProbFloorHS============:"<<aProbFloorHS[iH][iS][iV]<<endl; 
           //           cout<<"=================Before aProbNonFloor===========:"<<aProbNonFloorHS[iH][iS][iV]<<endl;       
           //     }    
             ...
             //  if(aProbFloorHS[iH][iS][iV] >  aProbNonFloorHS[iH][iS][iV])
             //   {
             //         cout<<"=================After aProbFloorHS============:"<<aProbFloorHS[iH][iS][iV]<<endl; 
             //         cout<<"=================After  aProbNonFloor===========:"<<aProbNonFloorHS[iH][iS][iV]<<endl;       
             //   }    

 
              // cout<<"aProbFloorHS:"<<iH<<" "<<" "<<iS<<" "<<iV<<": "<<aProbFloorHS[iH][iS][iV]<<endl; 
              // cout<<"aProbNonFloorHS:"<<iH<<" "<<" "<<iS<<" "<<iV<<": "<<aProbNonFloorHS[iH][iS][iV]<<endl;
